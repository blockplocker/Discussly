...
namespace Discussly.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<DiscusslyUser> _userStore;
        ...
        private DiscusslyUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DiscusslyUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(DiscusslyUser)}'. " +
                    $"Ensure that '{nameof(DiscusslyUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<DiscusslyUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<DiscusslyUser>)_userStore;
        }
    }
}
